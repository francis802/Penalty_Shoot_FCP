...
----------
- class Penalty_Shoot: implements an OpenAI custom gym
...
class Penalty_Shoot(gym.Env):
    def __init__(self, ip, server_p, monitor_p, r_type, enable_draw) -> None:
        ...
        self.kick_obj : Basic_Kick = self.player.behavior.get_custom_behavior_object("Basic_Kick") # Basic Kick behavior object
        ...
        self.no_of_actions = act_size = 22 # number of joints
    ...
    def step(self, action):
        ...
        reward = self.reward_function() # compute reward
        self.lastx = r.cheat_abs_pos[0]
    ...
    def is_terminal_state(self):
        ...
        if goal or out_of_bounds:
            ...
            return True
        elif self.step_counter > 500: # 10s passed and robot has not fallen (may be stuck)
            return True
        else:
            return False
